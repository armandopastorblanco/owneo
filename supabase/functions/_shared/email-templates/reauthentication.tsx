...
import { Body, Container, Head, Heading, Hr, Html, Preview, Section, Text, Img } from 'npm:@react-email/components@0.0.22'
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 700 as const, color: '#bda095', letterSpacing: '6px', textAlign: 'center' as const, margin: '12px 0 24px' }
