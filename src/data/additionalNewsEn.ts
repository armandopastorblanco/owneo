...
export const newsEn: Record<string, NewsArticleEn> = {
  "lamborghini-temerario-spyder-2026": {
    excerpt: "After months of spy shots at the Nürburgring, Lamborghini officially unveils the Temerario Spyder at the 2026 Goodwood Festival of Speed. The same 920 hp hybrid twin-turbo V8 as the coupé, open-top, and still capable of approaching 10,000 rpm. Sant'Agata Bolognese redefines the high-performance convertible.",
    intro: "The Goodwood Festival of Speed has historically been Lamborghini's stage of choice for its most spectacular unveilings, and the Temerario Spyder is no exception. Confirming predictions that pointed to a July 2026 reveal, Sant'Agata Bolognese unveils the open-top version of the Huracán successor with all the power and technical sophistication of the coupé, adding the sensory dimension that only an open roof can provide. The question the industry was asking was whether Lamborghini could maintain the structural rigidity needed to preserve the coupé's dynamic feel in an open-top body. The answer, as expected, is yes.",
    sections: [
      { title: "920 hp hybrid V8: the same formula, open to the sky", paragraphs: ["The heart of the Temerario Spyder is identical to the coupé: the 4.0-litre L411 twin-turbo V8 with three electric motors, one on the rear axle and two on the front, delivering a combined output of 920 hp. The combustion engine can rev to nearly 10,000 rpm, an extraordinary figure for a supercharged V8 that gives the Temerario a sound character and response unique in its segment.", "The eight-speed dual-clutch transmission manages the power with Lamborghini's characteristic precision, and the torque vectoring system between the front and rear axles guarantees agility and traction that no rival convertible can match. The Spyder's performance figures are virtually identical to the coupé: 0 to 100 km/h in 2.7 seconds and a top speed of 343 km/h."] },
      { title: "Reinforced structure and retractable soft top", paragraphs: ["Lamborghini has reinforced the Temerario Spyder's chassis with additional carbon fibre cross-members that compensate for the absence of the fixed roof. The result is a torsional rigidity that, according to Sant'Agata Bolognese, exceeds that of many rival coupés, thanks to the extensive use of carbon fibre in all structural elements.", "The retractable soft top operates in under 15 seconds and can be actuated on the move at speeds of up to 50 km/h. In the open position, the hood design integrates cleanly into the rear, without creating the unwanted bulk that penalises some conventional convertibles. The roll-over bar, integrated into the design, automatically deploys in the event of a rollover."] },
      { title: "Design and position in the range", paragraphs: ["The Temerario Spyder maintains the aggressive and futuristic lines of the coupé, adapted to the structural requirements of an open-top body. The lateral air outlets, active front end, and rear diffuser are shared with the coupé, maintaining the aesthetic coherence of the range. The Spyder's price sits above the coupé, with estimates pointing to 280,000 euros as a starting point, before Ad Personam programme options.", "With the Temerario Spyder, Lamborghini consolidates its offering in the high-performance open-top supercar segment, a market in which competition from the Ferrari 12Cilindri Spider and the McLaren 750S Spider is increasingly intense."] }
    ]
  },
  "porsche-911-gt3-touring-2025": {
    excerpt: "The Porsche 911 GT3 with Touring package removes the large fixed wing in favour of an integrated spoiler, retaining all 502 hp of the 4.0-litre naturally aspirated boxer and full competition-grade mechanicals. For those who want the real GT3 without making a statement.",
    intro: "Since its introduction, the 911 GT3 Touring package has been one of Porsche's great successes: offering all the mechanicals of the most sporting model in the 911 range with a more discreet exterior, designed for those who prefer subtlety to ostentation. The 992.2 generation GT3 Touring takes this concept to its fullest expression, with a 4.0-litre naturally aspirated 502 hp boxer engine that represents the pinnacle of Zuffenhausen's naturally aspirated engine engineering, combined with a body that could be mistaken for a standard 911 at first glance.",
    sections: [
      { title: "4.0 naturally aspirated boxer: the greatest Porsche engine ever made", paragraphs: ["The GT3 Touring's engine is the same as the standard GT3: a 4.0-litre six-cylinder naturally aspirated boxer delivering 502 hp at 9,000 rpm and 465 Nm at 6,100 rpm, with a redline at 9,000 rpm. It is a powertrain that currently has no rival among high-performance production cars, with a linear power delivery and a sound that no turbocharged engine can replicate.", "The seven-speed PDK transmission and rear-wheel drive complete a dynamic package that Porsche has perfected over decades. The 0 to 100 km/h sprint is completed in 3.4 seconds, and the top speed exceeds 320 km/h. The chassis, with rear-wheel steering and optional carbon-ceramic brakes, is derived directly from motorsport."] },
      { title: "Touring: discretion without compromise", paragraphs: ["The fundamental aesthetic difference between the GT3 and the GT3 Touring lies in the rear spoiler. The Touring replaces the large fixed carbon fibre wing with a spoiler integrated into the bonnet lid that deploys automatically according to speed, maintaining the necessary aerodynamic downforce without the visual impact of the conventional GT3's biplane wing.", "Inside, the GT3 Touring can be configured with leather seats instead of the fabric bucket seats of the more sporting models, and offers a greater number of comfort options that make it more suited to everyday road use. However, all the chassis electronics, driving modes, and sporting tuning are shared with the standard GT3."] },
      { title: "Price and availability", paragraphs: ["The Porsche 911 GT3 Touring starts from a price of $234,195 in the US market, approximately 220,000 euros in Europe. With the options catalogue, the price can easily exceed 280,000 euros. Demand consistently outstrips available supply, with waiting lists in most markets."] }
    ]
  },
  "bentley-continental-gt-speed-2026": {
    excerpt: "Bentley unveils the 2026 Continental GT Speed with a plug-in hybrid system that raises combined output to 782 hp on the twin-turbo V8 base. Crewe's most exclusive grand tourer reaches 335 km/h and completes the 0 to 100 km/h sprint in 3.2 seconds. A new era for the GT Speed.",
    intro: "The Continental GT Speed has always represented the pinnacle of the Continental range, the model that takes Bentley's grand tourer concept to its most powerful and dynamic expression. With the 2026 generation, Crewe takes a historic step by adopting plug-in electrification in its most sporting model, combining the 4.0-litre twin-turbo V8 with an electric motor to achieve a combined 782 hp. Far from softening the Speed's character, the hybrid system intensifies it: the instant electric thrust eliminates any sense of delay in engine response and multiplies the energy available during acceleration.",
    sections: [
      { title: "Plug-in hybrid V8: the most powerful GT Speed ever", paragraphs: ["The 2026 Continental GT Speed's drivetrain combines the revised 4.0-litre twin-turbo V8 with an electric motor integrated into the eight-speed dual-clutch gearbox. The combined output of 782 hp and 1,000 Nm of torque makes the GT Speed the most powerful Continental ever produced at Crewe.", "The performance lives up to the figures: 0 to 100 km/h in 3.2 seconds and a top speed of 335 km/h. Permanent all-wheel drive manages the flow of power with an efficiency that guarantees maximum traction in any weather condition, always maintaining the refined dynamic behaviour that characterises great Bentleys."] },
      { title: "British craftsmanship in the electric age", paragraphs: ["The interior of the 2026 Continental GT Speed maintains the artisanal standards that have defined Bentley for more than a century. Hand-stitched leather, sustainably sourced polished wood, and turned aluminium coexist with a new infotainment interface that integrates hybrid system management intuitively. The rotating glass display and high-resolution screens coexist with the analogue details that Bentley customers appreciate.", "The 2026 GT Speed also debuts new Mulliner programme personalisation options, with exclusive body, wheel, and interior finishes that allow each customer to create a unique example. The starting price is around 260,000 euros in Europe before options."] },
      { title: "Positioning and delivery", paragraphs: ["With the 2026 GT Speed, Bentley demonstrates that electrification can coexist with the luxury grand tourer tradition without sacrificing any of the qualities that make this model unique. First deliveries to European customers are underway, with demand exceeding available production in key markets."] }
    ]
  },
  "mclaren-750s-spider-2025": {
    excerpt: "The McLaren 750S Spider takes the 720S experience to the next level with 750 hp, a weight of just 1,277 kg, and a retractable carbon fibre roof that operates in 11 seconds. It is the most balanced and accessible McLaren in the Super Series segment, with first European deliveries complete.",
    intro: "McLaren has built its reputation on dynamic purity and the relationship between driver and car. The 750S Spider takes that philosophy into the open-top supercar segment with a formula that prioritises minimum weight, maximum power, and active aerodynamics that work in perfect coordination with the mechanical package. The result is a car that, on paper, might seem like an evolution of the 720S Spider, but on the road represents a significant qualitative leap in precision, response, and limit-handling capability.",
    sections: [
      { title: "750 hp and 1,277 kg: the perfect equation", paragraphs: ["The 750S Spider's engine is the 4.0-litre M840T twin-turbo V8 in its most powerful iteration, with 750 hp at 8,500 rpm and 800 Nm of torque. The seven-speed dual-clutch transmission and rear-wheel drive complete a package that takes the car's dynamic behaviour to a level practically indistinguishable from a pure track supercar.", "The kerb weight of 1,277 kg — barely 40 kg more than the 750S coupé — is a consequence of the use of carbon fibre body panels, the MonoCell II-T carbon fibre monocoque structure, and an engineering philosophy that rejects unnecessary weight in every component. The 0 to 100 km/h sprint is completed in 2.8 seconds, and 0 to 200 km/h in under 7.9 seconds."] },
      { title: "Carbon fibre roof and Proactive Chassis Control II", paragraphs: ["The 750S Spider's retractable roof is made from carbon fibre, which helps maintain minimum weight and preserve the structural rigidity of the monocoque. It operates in 11 seconds and can be actuated at up to 50 km/h, integrating cleanly into the rear without altering the car's lines when stowed.", "The Proactive Chassis Control II system, with hydraulically actuated dampers that individually adjust the response at each wheel, is the key to the 750S Spider's extraordinary dynamic capability. In Sport and Track modes, the car acquires a precision and communication that very few convertibles on the market can match. European deliveries to customers have been underway since early 2025."] },
      { title: "Price and competitors", paragraphs: ["The McLaren 750S Spider starts at a price close to $370,000 in the US market, with a European equivalent of approximately 320,000 euros before taxes and options. It positions itself directly against the Ferrari 12Cilindri Spider and the Lamborghini Temerario Spyder, with the lower weight advantage as its main differentiating argument."] }
    ]
  },
  "rolls-royce-phantom-2026": {
    excerpt: "Rolls-Royce refines the Phantom for 2026 with new Bespoke personalisation options, next-generation exclusive materials, and connectivity updates. The 6.75-litre twin-turbo V12 with 563 hp remains unchanged. The architecture of excellence requires no revolution, only evolution.",
    intro: "The Rolls-Royce Phantom needs no introduction. Since 1925, the name has defined the concept of absolute luxury motoring, the car that all others aspire to emulate without ever succeeding. The 2026 update does not seek to revolutionise a model that already represents the pinnacle of the industry, but to refine it in the aspects that the world's most demanding customers value: unlimited personalisation, the highest quality materials, and the most silent and refined driving experience on the planet.",
    sections: [
      { title: "Eternal V12: 6.75 litres of silence", paragraphs: ["The heart of the 2026 Phantom remains the 6.75-litre twin-turbo V12, an engine with its own history in the annals of Rolls-Royce. With 563 hp at 5,000 rpm and 900 Nm available from 1,700 rpm, the engine delivers power in a way that feels more like a force of nature than the operation of a conventional engine. The eight-speed automatic transmission works imperceptibly, and over 130 kg of sound-absorbing material ensures that the only sound in the cabin is the one the occupant chooses to hear.", "The air suspension with electronically controlled dampers and four-wheel steering contribute to a ride experience that Rolls-Royce calls the 'Magic Carpet Ride', capable of completely isolating occupants from any road surface irregularity."] },
      { title: "Bespoke 2026: personalisation without limits", paragraphs: ["The most significant innovations of the 2026 Phantom are found in the Bespoke programme. Rolls-Royce expands the catalogue of available woods, metals, and leathers, incorporating new species of FSC-certified sustainably sourced wood, next-generation metal alloys for decorative elements, and an expanded palette of hand-dyed leathers from the historic Cornish tannery.", "The Gallery, the glazed instrument panel that allows unique objects to be housed between two layers of glass, receives new high-resolution LED lighting possibilities that allow personalised light compositions to be created. Connectivity is updated with the integration of wireless Apple CarPlay and a new Bespoke audio system co-designed with a world-reference high-fidelity equipment manufacturer."] },
      { title: "The Phantom as investment and legacy", paragraphs: ["The price of the 2026 Rolls-Royce Phantom starts from 520,000 euros in Europe, a figure that can be multiplied several times with the full Bespoke programme. The waiting list, standard for all recently produced Phantoms, extends between 12 and 24 months depending on the level of personalisation. For their owners, the Phantom is not just a car: it is a functional work of art conceived to last generations."] }
    ]
  },
  "ferrari-12cilindri-spider-2025": {
    excerpt: "Ferrari introduces the 12Cilindri Spider, the open-top version of Maranello's most thrilling V12 grand tourer. 830 hp at 9,500 rpm, 1,570 kg, and a retractable glass roof in 14 seconds. The purest naturally aspirated V12 experience Ferrari has offered in decades.",
    intro: "If the 12Cilindri coupé was already a love letter to the naturally aspirated twelve-cylinder engine in an era of increasing electrification, the Spider takes that declaration to its maximum. Ferrari has created not just a convertible, but a complete sensory experience: the possibility of hearing the unfiltered 6.5-litre 830 hp V12 as it spins to 9,500 rpm is something no other manufacturer can currently offer. The 12Cilindri Spider is not simply a 12Cilindri without a roof: it is an engineering feat that has required a complete revision of the structure and opening system to preserve the coupé's dynamic sensations with all the added intensity that the open sky provides.",
    sections: [
      { title: "Maranello's most advanced naturally aspirated V12", paragraphs: ["The 12Cilindri Spider's engine is the F140HD: a 6.5-litre naturally aspirated V12 delivering 830 hp at 9,250 rpm and 678 Nm of torque. The redline at 9,500 rpm is a figure that few production engines in the world can reach, and the completely linear power delivery from low revs to the limit of the rev counter defines the unique driving experience that only a Ferrari V12 can offer.", "The eight-speed dual-clutch transmission and rear-wheel drive complete a package that Maranello has perfected over decades. The 0 to 100 km/h sprint is completed in 2.9 seconds, and the top speed exceeds 320 km/h. The kerb weight of 1,570 kg is extraordinarily controlled for a V12 convertible grand tourer with all active features."] },
      { title: "Retractable glass roof: the Ferrari solution", paragraphs: ["Ferrari has opted for a retractable glass roof rather than a fabric hood, a decision with both aesthetic and dynamic implications. The glass Retractable Hard Top (RHT) operates in 14 seconds and can be actuated on the move at up to 45 km/h. The filtered glass structure reduces solar heat and preserves cabin luminosity even with the roof closed.", "The structural rigidity of the 12Cilindri Spider has been achieved through extensive use of carbon fibre at key chassis points, with the aim of matching the coupé's dynamic experience. The Ferrari active suspension, the latest-generation Side Slip Control system, and the E-Diff3 electronic limited-slip differential work in synergy to offer benchmark dynamics in the segment."] },
      { title: "Price and exclusivity", paragraphs: ["The Ferrari 12Cilindri Spider starts at an approximate price of 465,000 euros in Europe, around 50,000 euros more than the equivalent coupé. The waiting list exceeds 18 months in most European markets, with all examples from the first allocation already committed. For their owners, the 12Cilindri Spider is not just a luxury car: it is the last opportunity to experience Ferrari's naturally aspirated V12 in its purest and most emotional form."] }
    ]
  },
