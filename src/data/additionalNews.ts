...
const articlesEs: NewsArticle[] = [
    ...
    content: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Lamborghini ha reforzado el chasis del Temerario Spyder con travesaños adicionales de fibra de carbono que compensan la ausencia del techo fijo. El resultado es una rigidez torsional que, según Sant'Agata Bolognese, supera a la de muchos coupéés de la competencia, gracias al uso extensivo de la fibra de carbono en todos los elementos estructurales.",
          ...
          paragraphs_en: [
            "Lamborghini has reinforced the Temerario Spyder's chassis with additional carbon fibre cross-members that compensate for the absence of the fixed roof. The result is a torsional rigidity that, according to Sant'Agata Bolognese, exceeds that of many rival coupéés, thanks to the extensive use of carbon fibre in all structural elements.",
        ...
        },
        {
          ...
          paragraphs: [
            "El Temerario Spyder mantiene la línea agresiva y futurista del coupéé, adaptada a las exigencias estructurales de una carrocería abierta. Las salidas de aire laterales, el frontal activo y el difusor trasero son compartidos con el coupéé, manteniendo la coherencia estética de la gama. El precio del Spyder se sitúa por encima del coupéé, con estimaciones que apuntan a los 280.000 euros como punto de partida, antes de opciones del programa Ad Personam.",
          ...
          paragraphs_en: [
            "The Temerario Spyder maintains the aggressive and futuristic lines of the coupéé, adapted to the structural requirements of an open-top body. The lateral air outlets, active front end, and rear diffuser are shared with the coupéé, maintaining the aesthetic coherence of the range. The Spyder's price sits above the coupéé, with estimates pointing to 280,000 euros as a starting point, before Ad Personam programme options.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "El peso de 1.277 kg en orden de marcha —apenas 40 kg más que el coupéé 750S— es consecuencia de la utilización de paneles de carrocería en fibra de carbono, la estructura del monocasco MonoCell II-T en fibra de carbono y una filosofía de ingeniería que rechaza el peso innecesario en cada componente. El 0 a 100 km/h se completa en 2,8 segundos, y el 0 a 200 km/h en menos de 7,9 segundos."
          ],
          paragraphs_en: [
            ...
            "The kerb weight of 1,277 kg — barely 40 kg more than the 750S coupéé — is a consequence of the use of carbon fibre body panels, the MonoCell II-T carbon fibre monocoque structure, and an engineering philosophy that rejects unnecessary weight in every component. The 0 to 100 km/h sprint is completed in 2.8 seconds, and 0 to 200 km/h in under 7.9 seconds."
          ]
        },
        {
  ...
  },
  {
    ...
    readTime: "7 min",
    content: {
      intro: "Si el 12Cilindri coupéé ya era una declaración de amor al motor de doce cilindros atmosférico en una era de electrificación creciente, el Spider lleva esa declaración al máximo. Ferrari ha creado no solo un descapotable, sino una experiencia sensorial completa: la posibilidad de escuchar sin filtros el V12 de 6,5 litros y 830 CV mientras gira hasta los 9.500 rpm es algo que ningún otro fabricante puede ofrecer en la actualidad. El 12Cilindri Spider no es simplemente un 12Cilindri sin techo: es una obra de ingeniería que ha requerido una revisión completa de la estructura y del sistema de apertura para preservar las sensaciones dinámicas del coupéé con toda la intensidad añadida que ofrece el cielo abierto.",
      intro_en: "If the 12Cilindri coupéé was already a love letter to the naturally aspirated twelve-cylinder engine in an era of increasing electrification, the Spider takes that declaration to its maximum. Ferrari has created not just a convertible, but a complete sensory experience: the possibility of hearing the unfiltered 6.5-litre 830 hp V12 as it spins to 9,500 rpm is something no other manufacturer can currently offer. The 12Cilindri Spider is not simply a 12Cilindri without a roof: it is an engineering feat that has required a complete revision of the structure and opening system to preserve the coupéé's dynamic sensations with all the added intensity that the open sky provides.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs_en: [
            ...
            "The structural rigidity of the 12Cilindri Spider has been achieved through extensive use of carbon fibre at key chassis points, with the aim of matching the coupéé's dynamic experience. The Ferrari active suspension, the latest-generation Side Slip Control system, and the E-Diff3 electronic limited-slip differential work in synergy to offer benchmark dynamics in the segment."
          ]
        },
        {
  ...
  },
  {
    ...
    content: { intro: "Celebrando 60 años de producción Volante, Aston Martin ha presentado el Vanquish Volante, equipado con el potente motor V12 biturbo de 5.2 litros que genera 824 CV. Es el convertible de motor delantero más rápido de la historia de Aston Martin, capaz de alcanzar 345 km/h.", sections: [
      ...
      { title: "Producción y precio", paragraphs: ["La producción del Vanquish Volante, combinada con la del coupéé, está limitada a menos de 1.000 unidades anuales. Las entregas comienzan a finales de 2025 con un precio estimado superior a 350.000 euros."] }
    ] },
  ...
  },
  {
    ...
    title: "Rolls-Royce Spectre Black Badge: la versión más oscura y potente del coupéé eléctrico",
    ...
    readTime: "6 min",
    content: { intro: "Rolls-Royce ha presentado el Spectre Black Badge, la versión más poderosa y expresiva de su revolucionario coupéé eléctrico. Con un aumento de potencia hasta 612 CV, acabados exclusivos en negro cromado y un carácter de conducción más dinámico, el Spectre Black Badge redefine el lujo eléctrico.", sections: [
    ...
    content: {
      ...
      sections: [
        { title: "V12 atmosférico de 825 CV con asistencia eléctrica", paragraphs: [
          "El propulsor central trasero conserva la arquitectura V12 a 60° de 6.5 litros del Revuelto coupéé: 825 CV a 9.250 rpm, una zona roja que sigue erizando la piel y un sonido que ha sido especialmente afinado para apreciarse con el techo abierto. Tres motores eléctricos suman 190 CV adicionales, llevando la potencia total a 1.015 CV.",
          "La estructura reforzada para compensar la ausencia de techo apenas añade 95 kg respecto al coupéé. El monocasco íntegramente en fibra de carbono garantiza la rigidez torsional necesaria para que el comportamiento dinámico siga siendo el de un superdeportivo de referencia."
        ]},
        { title: "Techo de carbono y artesanía", paragraphs: [
          "El techo rígido se compone de dos paneles de fibra de carbono que se almacenan en el frontal en apenas 12 segundos, a velocidades de hasta 50 km/h. Con el techo cerrado, el coeficiente aerodinámico se mantiene prácticamente intacto respecto al coupéé.",
    ...
    content: {
      ...
      sections: [
        { title: "V12 de aspiración natural sin compromiso", paragraphs: [
          ...
          "Las prestaciones se mantienen prácticamente intactas respecto al coupéé: 0 a 100 km/h en 2,9 segundos, 0 a 200 km/h en menos de 8 segundos y una velocidad máxima superior a 340 km/h. Una rareza absoluta entre los descapotables actuales, casi todos abocados al downsizing y al híbrido."
        ]},
        { title: "Techo retráctil de aluminio", paragraphs: [
          ...
          "El interior recoge la filosofía neo-clásica del coupéé, con dos pantallas digitales para conductor y pasajero, controles físicos en el volante y materiales premium aplicados con la habitual maestría de Maranello. El precio se sitúa en torno a los 425.000 euros y las entregas comenzarán a finales de 2026."
        ]}
      ]
    },
    ...
    content: {
      ...
      sections: [
        ...
        { title: "Techo de carbono extraíble", paragraphs: [
          ...
          "Las puertas Dihedral con apertura hacia arriba se mantendrían, y la aerodinámica activa Active Long Tail funcionaría exactamente como en el coupéé, generando hasta 1.000 kg de carga aerodinámica a 280 km/h. Se especula con una producción limitada, aunque McLaren no ha confirmado cifras oficiales."
        ]}
      ]
    },
