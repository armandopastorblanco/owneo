      ...
      <article className="py-16 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            ...
            <p className="text-base leading-relaxed mb-6">
              El motor V16 de 8,3 litros del Tourbillon es, sin exageración, la pieza de ingeniería mecánica más extraordinaria jamás instalada en un automóvil de producción. Desarrollado por Cosworth en colaboración con los ingenieros de Bugatti, este propulsor genera 1.000 CV a un régimen de 9.000 rpm — todo ello sin recurrir a ningún tipo de sobrealimentación. Su peso de apenas 252 kg es un logro monumental para un motor de esta cilindrada.
            </p>
            <p className="text-base leading-relaxed mb-12">
              El sonido del V16 es simplemente indescriptible. Un rugido profundo y aterciopelado en ralentí que se transforma en un aullido cristalino a alto régimen, pasando por toda la gama de frecuencias como una orquesta sinfónica. Bugatti ha trabajado meticulosamente en la acústica, utilizando un sistema de escape en inconel — una aleación aeroespacial — que amplifica las frecuencias más placenteras mientras atenúa las indeseadas.
            </p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            ...
            <p className="text-base leading-relaxed mb-6">
              El interior del Tourbillon es posiblemente el más elaborado de cualquier automóvil en producción. La pieza central es un cuadro de instrumentos analógico fabricado con técnicas de alta relojería suiza, con más de 600 piezas ensambladas a mano que incluyen rubíes, zafiros y engranajes de titanio. Este instrumento mecánico funciona independientemente de la electrónica del vehículo y muestra velocidad, régimen del motor y nivel de combustible con la elegancia de un reloj de complicación.
            </p>
            <p className="text-base leading-relaxed mb-12">
              Los materiales son exquisitos: cristal de zafiro para las superficies transparentes, aluminio mecanizado en bloque para los controles, cuero natural con curtido vegetal de la más alta calidad y madera de fresno con acabado artesanal. Cada Tourbillon requiere más de 200 horas solo para el montaje del interior, y los propietarios pueden personalizar prácticamente cada detalle a través del programa Sur Mesure de Bugatti.
            </p>
          </motion.div>
