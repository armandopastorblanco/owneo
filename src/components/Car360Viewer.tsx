...
const Car360Viewer = ({ carName, gallery }: Car360ViewerProps) => {
  ...
  // Split gallery: first 4 exterior, last 2 interior
  const exteriorImages = gallery.slice(0, 4);
  const interiorImages = gallery.slice(4, 6);
  ...
  return (
    <section className="mb-12">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <h2 className="text-3xl font-bold text-foreground">Visualización 360°</h2>
        <ToggleGroup
          type="single"
          value={view}
